...
for i in string:
	...
	if (i.islower()):
		...
		if ((n + 3) < len(string) and (n - 3) >= 0):
			if (string[n-4].islower() and string[n-3].isupper() and 
				string[n-2].isupper() and string[n-1].isupper() and 
				string[n+1].isupper() and string[n+2].isupper() and 
				string[n+3].isupper() and string[n+4].islower()):
				print(i, end='')
